...
<?php include 'header.php';?>
 ...
 <ul style="margin-top:100px; list-style-type:none;  text-align:center;height:100%; width:200px; margin-left:450px;margin-right:400px"> 
 ...
 <li style="margin-top:30px;"><a href=""  style="color:white;background-color:#2196f3; padding:10px 90px 10px 5px; margin-top:50px; text-decoration: none; text-align:left;">Student Info</a></li>
   ...
   <li style="margin-top:30px;"><a href=""  style="color:white;background-color:#2196f3; padding:10px 90px 10px 5px; margin-top:50px; text-decoration: none; text-align:left;">Add Faculty</a></li>
